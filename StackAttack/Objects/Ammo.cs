...
namespace StackAttack.Objects
{
    ...
    {
        public Ammo() : base(0,0,0,Headings.North, null, "")
        {
        }

        public Ammo(int x, int y, float rotation, Headings heading, Game? game, string spriteID) : base(x, y, rotation, heading, game, spriteID)
        {
        }

        public override GameObject CreateNew(int x, int y, float rotation, Headings heading, Game? game, string spriteID)
        {
            return new Ammo(x, y, rotation, heading, game, spriteID);
        }
